...
PROTODEF {
  ...
  {MODULE_SUBTYPE_MULTI_FS_AFHDS2A, 6, true,  true,   STR_SUBTYPE_AFHDS2A,   STR_MULTI_SERVOFREQ},
  ...
  {MODULE_SUBTYPE_MULTI_XN297DUMP,  6, false, false,  STR_SUBTYPE_XN297DUMP, STR_MULTI_RFCHAN},
  ...
  {MODULE_SUBTYPE_MULTI_MOULDKG,    2, false, false,  STR_SUBTYPE_MOULDKG,   STR_MULTI_OPTION},
