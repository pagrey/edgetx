...
enum ModuleSubtypeMulti {
  ...
  MODULE_SUBTYPE_MULTI_EASYRC,  //60
  ...
  MODULE_SUBTYPE_MULTI_UDIRC, //100
  MODULE_SUBTYPE_MULTI_JIABAILE,
  MODULE_SUBTYPE_MULTI_H36,
  MODULE_SUBTYPE_MULTI_KAMTOM,
  MODULE_SUBTYPE_MULTI_SHENQI2,
  MODULE_SUBTYPE_MULTI_WL91X,
  MODULE_SUBTYPE_MULTI_WPL,
  //
...
#define KNOWN_PROTO_NAMES \
  ...
  "EasyRC", "XK","XN297DU","FrSkyX2","FrSkyR9","Propel","FrSky L","Skyartc","ESkyV2","DSM_RX",\
  ...
  "YuXiang","UDIRC","JIABAILE","H36","KAMTOM","Shenqi2","WL91x","WPL"
