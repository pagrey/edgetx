...
#if defined(RADIO_TX12) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_ZORRO) || defined(RADIO_T8) || defined(RADIO_COMMANDO8) || defined(RADIO_TLITE)
    ADD_2POS_CASE(A);
    ADD_3POS_CASE(B, 1);
    ADD_3POS_CASE(C, 2);
#elif defined(RADIO_TPRO) || defined(RADIO_LR3PRO)
    ADD_3POS_CASE(A, 0);
    ADD_3POS_CASE(B, 1);
    ADD_2POS_CASE(C);
    ADD_2POS_CASE(D);
